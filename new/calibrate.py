...
# --------------- Setup options ---------------
tcp_host_ip = '192.168.1.102' # IP and port to robot arm as TCP client (UR5)
tcp_port = 30002
rtc_host_ip = '192.168.1.102' # IP and port to robot arm as real-time client (UR5)
rtc_port = 30003
...
workspace_limits = np.asarray([[0.6, 0.7], [-0.2, -0.15], [0.2, 0.3]])
calib_grid_step = 0.05
checkerboard_offset_from_tool = [0.083,0,0]
#checkerboard_offset_from_tool = [0,-0.13,0.02]
tool_orientation =[0,np.pi/2,0] # [0,-2.22,2.22] # [2.22,2.22,0] [np.pi/2,0,0]
realsense_device_id = 141722072133
# ---------------------------------------------
...
robot = Robot(False, None, None, workspace_limits,
              ...
              False, None, None, realsense_device_id)
#robot.open_gripper()
